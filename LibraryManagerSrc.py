...
class ScrollableFrame(ttk.Frame):
    ...
    def __init__(self, container, *args, **kwargs):
        ...
        canvas = tk.Canvas(self, background="#1F1B24", bd=0, borderwidth=0, border=0, highlightthickness="0")
        scrollbar = ttk.Scrollbar(Root, orient="vertical", command=canvas.yview)
        self.scrollable_frame = ttk.Frame(canvas, style='TFrame', borderwidth=0, border=0)
        ...
        canvas.configure(yscrollcommand=scrollbar.set, background="#1F1B24", borderwidth=0, border=0)
